...
document.getElementById("autotrimp").insertAdjacentHTML('beforeend', '<div id="autotrimp" style="position: absolute; background: rgb(0, 0, 0) none repeat scroll 0% 0%; border: 2px solid rgb(0, 0, 0); width: 64vw; margin: 6vh 18vw; z-index: 10000000; text-align: center; font-size: 1.3vw; display: none; padding: 0.2vw; color: rgb(255, 255, 255);"><div style="width: 100%;" display: table; border-spacing: 0.3vw;" id="genBTCTrimp"><div style="display: table-row;" id="autorow"><div style="border: 1px solid white; background: rgb(153, 153, 77) none repeat scroll 0% 0%; display: table-cell; width: 20%;" id="pic2"><img style="max-height: 13vw;" src="https://avatars2.githubusercontent.com/u/3683744?v=3&s=400"></div><div ;display: table-cell; width: 60%; style="border: 1px solid white; background: rgb(153, 153, 77) none repeat scroll 0% 0%; display: table-cell; width: 80%; vertical-align: top; padding: 0.5%;"><p style="text-align: left; font-size: 0.9em;" id="autosettings0"> <a href="textfile.txt">Script Notes</a>');

//didnotwoktopline//document.getElementById("autotrimp").insertAdjacentHTML('beforebegin', '<div style="width: 100%; display: table; border-spacing: 0.3vw;" id="genBTCTrimp"><div style="border: 1px solid white; background: rgb(153, 153, 77) none repeat scroll 0% 0%; display: table-cell; width: 20%;" id="pic"><img style="max-height: 13vw;" src="https://avatars2.githubusercontent.com/u/3683744?v=3&s=400"></div><div id="qs" style="border: 1px solid white; background: rgb(153, 153, 77) none repeat scroll 0% 0%; display: table-cell; width: 80%; vertical-align: top; padding: 0.5%;"><p style="text-align: left; font-size: 0.9em;" id="q">This is the question.</p><p></p><p style="font-size: 0.8em;"><a style="color: rgb(0, 0, 0); text-decoration: underline;" href="#" id="1" onclick="alert(\'clicked\')">Answer 1</a></p><p style="font-size: 0.8em;"><a style="color: rgb(128, 0, 0); text-decoration: underline;" href="#" id="2" onclick="alert(\'clicked\')">Answer 2</a></p><p style="font-size: 0.8em;"><a style="color: rgb(128, 0, 0); text-decoration: underline;" href="#" id="3" onclick="alert(\'clicked\')"></a></p></div><div');
//wokrikingsettings//document.getElementById("autotrimp").insertAdjacentHTML('beforeend', '<div style="width: 100%; display: table; border-spacing:0.3vw;" id="genBTCTrimp"><div style="border: 1px solid white; background: rgb(0, 0, 0) none repeat scroll 0% 0%; width: 100%; padding: .3vw;" id="autosettings0">Script Notes</div></div>');
//document.getElementById("autotrimp").insertAdjacentHTML('beforeend', '<div style="width: 20%; display: table; border-spacing:0.3vw;" id="genBTCTrimp"><div style="border: 1px solid black; background: rgb(0, 0, 0) none repeat scroll 0% 0%; width: 100%; padding: .3vw;" table-cell; width: 20%;" id="pic"><img style="max-height: 13vw;" src=https://avatars2.githubusercontent.com/u/3683744?v=3&s=400"></div><div ;display: table-cell; width: 60%; id="autosettings0"> <a href="textfile.txt">Script Notes</a>');
//document.getElementById("autotrimp").insertAdjacentHTML('beforeend', '<div > <image src="> <a href="textfile.txt">words to link</a>');
