...
document.getElementById("science").insertAdjacentHTML('afterbegin', '<div id="pic"><img style="max-height: 6vw; float: left; background;" src="https://catbox.moe/pictures/qts/1468421480662.png"></div><div');
...
document.getElementById("wood").insertAdjacentHTML('afterbegin', '<div id="pic"><img style="max-height: 4vw; float: left; background;" src="https://cdn3.iconfinder.com/data/icons/construction-tools-and-material/512/Construction-Tools-Material-saw-wood-working-512.png"></div><div');
document.getElementById("metal").insertAdjacentHTML('afterbegin', '<div id="pic"><img style="max-height: 4vw; float: left; background;" src="https://cdn2.iconfinder.com/data/icons/science-solid-icons-vol-2/48/083-512.png"></div><div');
