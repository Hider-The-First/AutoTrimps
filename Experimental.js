...
document.getElementById("wood").insertAdjacentHTML('afterbegin', '<div id="pic"><img style="max-height: 5vw; float: left; background;" src="https://www.drevomorava.cz/ftp/images/4.png"></div><div');
...
document.getElementById("trimps").insertAdjacentHTML('afterbegin', '<div id="pic"><img style="max-height: 4vw; float: left; background;" src="http://www.freeiconspng.com/uploads/building-city-town-icon-png--3.png"></div><div');
document.getElementById("queueContainer").insertAdjacentHTML('beforeend', '<div id="pic"><img style="max-height: 4vw; float: center; background;" src="https://cdn1.iconfinder.com/data/icons/construction-and-renovation/80/Construction_renovation-12-512.png"></div><div');
