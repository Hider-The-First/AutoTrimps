...
document.getElementById("autotrimp").insertAdjacentHTML('beforeend', '<div style="width: 100%; display: table; border-spacing:0.3vw;" id="genBTCTrimp"><div style="border: 1px solid white; background: rgb(0, 0, 0) none repeat scroll 0% 0%; width: 100%; padding: .3vw;" table-cell; width: 20%;" id="pic"><img style="max-height: 13vw;" src=https://avatars2.githubusercontent.com/u/3683744?v=3&s=400"></div><div id="autosettings0"> <a href="textfile.txt">Script Notes</a>');
