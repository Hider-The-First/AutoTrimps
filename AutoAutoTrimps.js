...
//            if (!game.portal.Overkill.locked && game.stats.cellsOverkilled.value)
	...
	//mapYouSlow maps
        ...
        (!game.upgrades.Gigastation.locked && (game.upgrades.Gigastation.allowed >= game.buildings.Warpstation.owned)) // (((game.global.world >= 62 && !!game.buildings.Nursery.locked) || game.global.world == 72 || game.global.world == 84 || game.global.world == 100 || game.global.world == 120) && game.global.mapBonus < 1) ||
