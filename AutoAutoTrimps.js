...
function highlightHousing() {
	...
	if (!game.buildings.Nursery.locked && !game.buildings.Collector.locked && game.buildings.Tribute.owned > 1600 && getBuildingItemPrice(game.buildings.Collector, "gems", false, 1) * Math.pow(1 - game.portal.Resourceful.modifier, game.portal.Resourceful.level) < game.resources.gems.owned/10) {
        ...
        for (var best in keysSorted) {
            ...
            if (game.buildings[keysSorted[best]].owned < max || max == -1) {
                ...
                if ((hiderwindow < 6 && hiderwindow > 3)|| getPageSetting('WarpstationWall') && bestBuilding == "Warpstation") {
                    //Warpstation Wall - allow only warps that cost 1/n'th less then current metal (try to save metal for next prestige) 
        ...
        if (bestBuilding != "Warpstation" && !game.buildings.Warpstation.locked && game.global.world < 190) {
...
function buyFoodEfficientHousing() {
    ...
    autoTrimpSettings.MaxHut.value = game.global.world < 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.75 ? 0:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Hut, "food", false, 1) > 5 ? -1:0)) : 50//10+game.buildings.House.owned;2.5 //game.global.world*2.3
    autoTrimpSettings.MaxHouse.value = game.global.world < 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.75 ? 0:(game.resources.food.owned/getBuildingItemPrice(game.buildings.House, "food", false, 1) > 5 ? -1:0)) : 50 // game.global.world*2.6
    autoTrimpSettings.MaxMansion.value = game.global.world < 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.75 ? 0:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Mansion, "food", false, 1) > 5 ? -1:0)) : 50//20+game.buildings.House.owned;2.9 // game.global.world*2.8
    autoTrimpSettings.MaxHotel.value = game.global.world < 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.75 ? 0:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Hotel, "food", false, 1) > 5 ? -1:0)) : 50 //30+game.buildings.House.owned;3.1 // game.global.world*3
    autoTrimpSettings.MaxResort.value = game.global.world < 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.75 ? 0:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Resort, "food", false, 1) > 5 ? -1:0)) : 50 //40+game.buildings.House.owned; 3.3 // game.global.world*3.2
    autoTrimpSettings.MaxGateway.value = game.global.world < 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.75 ? 0:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Gateway, "fragments", false, 1) > 5 ? -1:0)) : 20 // game.global.world*0.8
...
//            if (!game.portal.Overkill.locked && game.stats.cellsOverkilled.value)
	...
	//mapYouSlow maps
        ...
        (((game.global.mapBonus < 10 && hiderwindow < 3.5 ) || (game.global.mapBonus < 9 && hiderwindow < 4 ) || (game.global.mapBonus < 8 && hiderwindow < 4.5 ) || (game.global.mapBonus < 7 && hiderwindow < 5 ) || (game.global.mapBonus < 6 && hiderwindow < 5.5 ) || (game.global.mapBonus < 5 && hiderwindow < 6 ) || (game.global.mapBonus < 4 && hiderwindow < 6.5 ) || (game.global.mapBonus < 3 && hiderwindow < 7 ) || (game.global.mapBonus < 2 && hiderwindow < 7.5 ) || (game.global.mapBonus < 1 && hiderwindow < 8 )) ||	//Farm maps if you are way to slow
        ((((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 11 && hiderwindow < 3) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 12 && hiderwindow < 2.5) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 13 && hiderwindow < 2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 14 && hiderwindow < 1.5) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 15 && hiderwindow < 1) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 16 && hiderwindow < 0.5) ||
        (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 17 && hiderwindow < 0.4)) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 18 && hiderwindow < 0.3) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 19 && hiderwindow < 0.2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 20 && hiderwindow < 0.1)) || // (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 21 && hiderwindow < 3.2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 22 && hiderwindow < 3) ||
        //(((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 23 && hiderwindow < 3)) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 24 && hiderwindow < 2.8) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 25 && hiderwindow < 2.6) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 26 && hiderwindow < 2.4) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 27 && hiderwindow < 2.2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 28 && hiderwindow < 2) ||
        ((game.global.preMapsActive || game.global.mapsActive) && (getBreedTime(true) > 5 || (game.global.antiStacks < 30 && (game.global.challengeActive !== "Daily" || (typeof game.global.dailyChallenge.bogged == 'undefined' && typeof game.global.dailyChallenge.plague == 'undefined')))) && hiderwindow < 4)   //typeof game.global.dailyChallenge.weakness == 'undefined' && typeof game.global.dailyChallenge.toxic == 'undefined' && 
    ...
    if (shouldDoMaps || doVoids || needPrestige) {
        ...
        if (selectedMap == "world") {
            ...
            if (needPrestige)
                if (game.global.world == game.global.mapsOwnedArray[highestMap].level) // && 26 == game.global.mapsOwnedArray[highestMap].size && 182 < game.global.mapsOwnedArray[highestMap].loot)
...
function manageGenes() {
    ...
    else if ((targetBreed*1.02 < getBreedTime() || targetBreed*1.02 < getBreedTime(true) || (game.global.challengeActive == "Daily" && game.global.antiStacks+1 > target1.defaultValue)) && !game.jobs.Geneticist.locked && game.jobs.Geneticist.owned > 10 && getBreedTime(true) > 2) { //&& getBreedTime(true) > 2
...
function betterAutoFight() {
    ...
    if (game.upgrades.Battle.done && !game.global.fighting && game.global.soldierHealth == 0 && (game.resources.trimps.realMax()/100 > game.resources.trimps.maxSoldiers || game.resources.trimps.realMax()/1000 >= game.resources.trimps.owned) && typeof game.global.dailyChallenge.plague == 'undefined') {
        fightManual();
}
...
function mainLoop() {
    ...
    if (autoTrapBtn.innerHTML != "AutoTraps Off") toggleAutoTrap();
...
function updateValueFields3() {
    ...
    var Area60 = document.getElementById('Area60');
    Area52.innerHTML = getStats() + ' He/hr'; //'S-DMG: ' + (Area51i).toPrecision(2) + '<br>Max-HP: ' + (Area60i).toPrecision(2) + '<br>He/hr: ' + getStats(); 
}
