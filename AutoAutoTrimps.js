	...
	if (game.buildings.Tribute.owned > 1600 && getBuildingItemPrice(game.buildings.Collector, "gems", false, 1) * Math.pow(1 - game.portal.Resourceful.modifier, game.portal.Resourceful.level) < game.resources.gems.owned/10) {
        ...
        for (var best in keysSorted) {
            ...
            if (game.buildings[keysSorted[best]].owned < max || max == -1) {
                ...
                if (game.global.world >= getPageSetting('VoidMaps') || getPageSetting('WarpstationWall') && bestBuilding == "Warpstation") {
...
function getNiceThingsDone() {
	...
	document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><img style="width: 100%; vertical-align; background;" src="http://4hdwallpapers.com/wp-content/uploads/2014/12/road_summer-Beautiful_natural_scenery_Desktop_Wallpapers_1366x768-1024x575.jpg"></div><div');
	} else if (game.global.preMapsActive) {
	document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><img style="width: 100%; vertical-align; background;" src="https://images6.alphacoders.com/695/695567.jpg"></div><div');
	} else if (game.global.mapsActive && getCurrentMapObject().location == "Void") {
	document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><img style="width: 100%; vertical-align; background;" src="http://www.wallpapersxl.com/wallpapers/1920x1200/dreams/1502375/dreams-planet-and-nebula-fantasy-1502375.jpg"></div><div');
	} else if (game.global.mapsActive && getCurrentMapObject().location != "Void") {
	document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><img style=width: 100%; vertical-align; background;" src="http://previews.123rf.com/images/zhudifeng/zhudifeng1205/zhudifeng120503093/13537723-An-Magnifier-on-a-Treasure-map-background--Stock-Photo-map-world-old.jpg"></div><div');
	} else if (game.global.world == 200 && game.global.spireActive) {
	document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><img style="width: 100%; vertical-align; background;" src="http://vignette3.wikia.nocookie.net/galaxycentre/images/e/e6/VORTEX_Wallpaper_0tk8x.jpg/revision/latest?cb=20131125141428"></div><div');
	}
}
