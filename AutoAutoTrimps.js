...
//            if (!game.portal.Overkill.locked && game.stats.cellsOverkilled.value)
	...
	//mapYouSlow maps
        ...
        (game.global.world >= 15 && ((game.global.mapsActive || game.global.preMapsActive) && game.global.mapBonus < 9) && ((new Date().getTime() - game.global.mapStarted) > (cellClearTime * game.global.mapGridArray.length) || hiderwindow.toFixed(0) < 0.06)) ||	//force to stay in mapYouSlow if you overkill all the cells unless you are about to hit max map bonus.
