...
//            if (!game.portal.Overkill.locked && game.stats.cellsOverkilled.value)
	...
	//mapYouSlow maps
        ...
        (((game.global.mapBonus < 10 && hiderwindow < 6.2 ) || (game.global.mapBonus < 9 && hiderwindow < 6.4 ) || (game.global.mapBonus < 8 && hiderwindow < 6.6 ) || (game.global.mapBonus < 7 && hiderwindow < 6.8 ) || (game.global.mapBonus < 6 && hiderwindow < 7 ) || (game.global.mapBonus < 5 && hiderwindow < 7.2 ) || (game.global.mapBonus < 4 && hiderwindow < 7.4 ) || (game.global.mapBonus < 3 && hiderwindow < 7.6 ) || (game.global.mapBonus < 2 && hiderwindow < 7.8 ) || (game.global.mapBonus < 1 && hiderwindow < 8 )) ||	//Farm maps if you are way to slow
        ((((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 11 && hiderwindow < 5) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 12 && hiderwindow < 4.8) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 13 && hiderwindow < 4.6) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 14 && hiderwindow < 4.4) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 15 && hiderwindow < 4.2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 16 && hiderwindow < 4) ||
	(((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 17 && hiderwindow < 4)) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 18 && hiderwindow < 3.8) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 19 && hiderwindow < 3.6) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 20 && hiderwindow < 3.4) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 21 && hiderwindow < 3.2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 22 && hiderwindow < 3) ||
