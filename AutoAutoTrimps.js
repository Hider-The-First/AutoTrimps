        ...
        if (!gameResource.locked) {
            ...
            if (
                ...
                (
                    ...
                    ||
                    ((getPageSetting('BuyArmorUpgrades') && ((equipmentList[equipName].Resource != 'metal') || ((gameResource.prestige+4 <= ((game.global.world-5)/5)) || (gameResource.prestige+2 <= ((game.global.world-5)/5) && ((game.global.soldierHealth > 0 && armorTempValue < 50) || armorValue < 1000))) || gameResource.prestige < 5 || game.global.world == 200 ) && (equipmentList[equipName].Stat == 'health'))
                        && 
