...
function autoMap() {
    ...
    var voidMapLevelSetting = hiderWindow < 10 ? getPageSetting('VoidMaps') : game.global.world;
        ...
        case "Helium Per Hour":
            ...
            if(game.global.world > lastHeliumZone) {
                ...
                if(game.global.world > game.stats.bestHeliumHourThisRun.atZone) {
                    ...
                    if(myHeliumHr < bestHeHr * (1-(heliumHrBuffer/100)) && !game.global.challengeActive && hiderWindow < 1 && game.global.world > getPageSetting('VoidMaps') && (game.global.totalVoidMaps == 0 || hiderWindow < 0.1)) {
