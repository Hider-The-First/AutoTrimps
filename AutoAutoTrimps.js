...
function buyFoodEfficientHousing() {
    ...
    autoTrimpSettings.MaxHut.value = (game.global.world < 35 || game.global.world > 190) ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Hut, "food", false, 1) > 5 ? 1000:1) : game.global.world*2.3; //10+game.buildings.House.owned;2.5		
    autoTrimpSettings.MaxHouse.value = (game.global.world < 35 || game.global.world > 190) ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.House, "food", false, 1) > 5 ? 1000:1) : game.global.world*2.6;		
    autoTrimpSettings.MaxMansion.value = (game.global.world < 35 || game.global.world > 190) ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Mansion, "food", false, 1) > 5 ? 1000:1) : game.global.world*2.8; //20+game.buildings.House.owned;2.9		
    autoTrimpSettings.MaxHotel.value = (game.global.world < 35 || game.global.world > 190) ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Hotel, "food", false, 1) > 5 ? 1000:1) : game.global.world*3; //30+game.buildings.House.owned;3.1		
    autoTrimpSettings.MaxResort.value = (game.global.world < 35 || game.global.world > 190) ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Resort, "food", false, 1) > 5 ? 1000:1) : game.global.world*3.2; //40+game.buildings.House.owned; 3.3		
    autoTrimpSettings.MaxGateway.value = (game.global.world < 35 || game.global.world > 190) ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Gateway, "fragments", false, 1) > 5 ? 1000:1) : game.global.world*0.8;
...
//            if (!game.portal.Overkill.locked && game.stats.cellsOverkilled.value)
	...
	//mapYouSlow maps
        ...
        ((game.global.mapBonus < 10 && hiderwindow < 2.2 ) || (game.global.mapBonus < 10 && hiderwindow < 2.2 ) || (game.global.mapBonus < 9 && hiderwindow < 2.4 ) || (game.global.mapBonus < 8 && hiderwindow < 2.6 ) || (game.global.mapBonus < 7 && hiderwindow < 2.8 ) || (game.global.mapBonus < 6 && hiderwindow < 3 ) || (game.global.mapBonus < 5 && hiderwindow < 3.2 ) || (game.global.mapBonus < 4 && hiderwindow < 3.4 ) || (game.global.mapBonus < 3 && hiderwindow < 3.6 ) || (game.global.mapBonus < 2 && hiderwindow < 3.8 ) || (game.global.mapBonus < 1 && hiderwindow < 4 )) ||	//Farm maps if you are way to slow
        ((((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 11 && hiderwindow < 2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 12 && hiderwindow < 1.8) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 13 && hiderwindow < 1.6) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 14 && hiderwindow < 1.4) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 15 && hiderwindow < 1.2) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 16 && hiderwindow < 1) || (((new Date().getTime() - game.global.zoneStarted) / 1000 /5) < 17 && hiderwindow < 0.8)) ||
