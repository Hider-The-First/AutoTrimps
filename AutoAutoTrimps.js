...
function manageGenes() {
    ...
    else if (!game.jobs.Geneticist.locked && (targetBreed*1.02 < getBreedTime() || targetBreed*1.02 < getBreedTime(true) || (game.global.challengeActive == "Daily" && game.global.antiStacks+1 > target1.defaultValue)) && game.jobs.Geneticist.owned > 10 && getBreedTime(true) > 2) { //&& getBreedTime(true) > 2
