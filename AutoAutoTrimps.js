...
function buyFoodEfficientHousing() {
    ...
    autoTrimpSettings.MaxHut.value = game.global.world > 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Hut, "food", false, 1) > 5 ? 1000:1)) : game.global.world*2.3; //10+game.buildings.House.owned;2.5		
    autoTrimpSettings.MaxHouse.value = game.global.world > 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.House, "food", false, 1) > 5 ? 1000:1)) : game.global.world*2.6;		
    autoTrimpSettings.MaxMansion.value = game.global.world > 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Mansion, "food", false, 1) > 5 ? 1000:1)) : game.global.world*2.8; //20+game.buildings.House.owned;2.9		
    autoTrimpSettings.MaxHotel.value = game.global.world > 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Hotel, "food", false, 1) > 5 ? 1000:1)) : game.global.world*3; //30+game.buildings.House.owned;3.1		
    autoTrimpSettings.MaxResort.value = game.global.world > 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Resort, "food", false, 1) > 5 ? 1000:1)) : game.global.world*3.2; //40+game.buildings.House.owned; 3.3		
    autoTrimpSettings.MaxGateway.value = game.global.world > 190 ? (game.resources.trimps.realMax()/game.resources.trimps.owned > 1.0001 ? 1:(game.resources.food.owned/getBuildingItemPrice(game.buildings.Gateway, "fragments", false, 1) > 5 ? 1000:1)) : game.global.world*0.8;
