...
createSetting('MaxHut', 'Max Huts', 'something', 'value', '50');
createSetting('MaxHouse', 'Max Houses', '1', 'value', '50');
createSetting('MaxMansion', 'Hider', '', 'value', '50');
createSetting('MaxHotel', 'MOteL', 'nonononono', 'value', '50');
