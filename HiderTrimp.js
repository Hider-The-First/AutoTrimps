...
function getNiceThingsDone() {
		...
		document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic">a href="zonePic"></div><div');
		} else if (game.global.preMapsActive) {
		document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><a href="PrePic"></div><div');
		} else if (game.global.mapsActive && getCurrentMapObject().location == "Void") {
		document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><a href="voidPic"></div><div');
		} else if (game.global.mapsActive && getCurrentMapObject().location != "Void") {
		document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><a href="mapPic"></div><div');
		} else if (game.global.world == 200 && game.global.spireActive) {
		document.getElementById("trimps").insertAdjacentHTML('afterend', '<div id="pic"><a href="spirePic"></div><div');
		}
