...
function getNiceThingsDone() {
    ...
    //bring the light.
    var AA0 = document.getElementById("AA").value*100;
	...
	if ((BR0 > 0 && BG0 > 0 && BB0 > 0) || (CR0 > 0 && CG0 > 0 && CB0 > 0)) {
        var colA = "background-color: rgba("+CR0+","+CG0+","+CB0+","+AA0+");";
