...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [65, 60, 6], 0.05); // , 20, 50, 120, 42, 160
var toughness = new AutoPerks.VariablePerk("toughness", 1, false,         [4, 4, 4], 0.05); // , 0.5, 0.75, 4, 1.75, 1.5
var power = new AutoPerks.VariablePerk("power", 1, false,                 [8, 5, 6], 0.05); // , 1, 1, 4, 5, 5
var motivation = new AutoPerks.VariablePerk("motivation", 2, false,       [7, 4, 5], 0.05); // , 1.5, 3, 4, 4, 2.5
...
var coordinated = new AutoPerks.VariablePerk("coordinated", 150000, true, [75, 70, 75], 0.1); // , 25, 60, 60, 100, 100
