...
var power = new AutoPerks.VariablePerk("power", 1, false,                 [(game.portal.Carpentry.level*1000/(6+game.portal.Power.level*(0.3+game.portal.Power_II.level/15000))).toFixed(), (game.portal.Carpentry.level*1000/(6+game.portal.Power.level*(0.3+game.portal.Power_II.level/15000))).toFixed()], 0.05); // , 1, 1, 4, 5, 5
var motivation = new AutoPerks.VariablePerk("motivation", 2, false,       [(game.portal.Carpentry.level*1000/(6+game.portal.Motivation.level*(0.3+game.portal.Motivation_II.level/15000))).toFixed(), (game.portal.Carpentry.level*1000/(6+game.portal.Motivation.level*(0.3+game.portal.Motivation_II.level/15000))).toFixed()], 0.05); // , 1.5, 3, 4, 4, 2.5
