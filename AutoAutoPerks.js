...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [((5+Math.pow(game.portal.Carpentry.level,1.1))).toFixed(2), ((5+Math.pow(game.portal.Carpentry.level,0.55))).toFixed(2), 100], 0.05); // , 20, 50, 120, 42, 160
...
var coordinated = new AutoPerks.VariablePerk("coordinated", 150000, true, [((24*(2+Math.pow(game.portal.Coordinated.level,0.3))).toFixed(2), ((24*(2+Math.pow(game.portal.Coordinated.level,0.3))).toFixed(2), 72], 0.1); // , 25, 60, 60, 100, 100
