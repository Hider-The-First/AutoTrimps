...
var coordinated = new AutoPerks.VariablePerk("coordinated", 150000, true, [(24*(2+Math.pow(game.portal.Coordinated.level,0.2))).toFixed(0), (24*(2+Math.pow(game.portal.Coordinated.level,0.2))).toFixed(0), 72], 0.1); // , 25, 60, 60, 100, 100
