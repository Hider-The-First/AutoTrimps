...
var pheromones = new AutoPerks.VariablePerk("pheromones", 3, false,       [(4*10/(10+Math.pow(game.portal.Coordinated.level,1.3))).toFixed(1), (4*10/(10+Math.pow(game.portal.Coordinated.level,1.3))).toFixed(1)], 0.1); // , 0.5, 0.75, 4, 1.5, 1.5
...
var resilience = new AutoPerks.VariablePerk("resilience", 100, true,      [(4*10/(10+Math.pow(game.portal.Coordinated.level,1.3))).toFixed(1), (4*10/(10+Math.pow(game.portal.Coordinated.level,1.3))).toFixed(1)], 0.1); // , 1, 1.5, 8, 3.5, 3
