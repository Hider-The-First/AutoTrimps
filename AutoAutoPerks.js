...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [((5+Math.pow(game.portal.Carpentry.level,1.2))).toFixed(0), ((5+Math.pow(game.portal.Carpentry.level,0.6))).toFixed(0), 100], 0.05); // , 20, 50, 120, 42, 160
