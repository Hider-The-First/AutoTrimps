...
var power = new AutoPerks.VariablePerk("power", 1, false,                 [10, 8, 8], 0.05); // , 1, 1, 4, 5, 5
var motivation = new AutoPerks.VariablePerk("motivation", 2, false,       [9, 7, 7], 0.05); // , 1.5, 3, 4, 4, 2.5
var pheromones = new AutoPerks.VariablePerk("pheromones", 3, false,       [0.01, 1, 0.01], 0.1); // , 0.5, 0.75, 4, 1.5, 1.5
var artisanistry = new AutoPerks.VariablePerk("artisanistry", 15, true,   [9, 7, 7], 0.1); // , 1.5, 3, 2, 5, 3.5
var carpentry = new AutoPerks.VariablePerk("carpentry", 25, true,         [24, 24, 18], 0.1); // , 8, 10, 24, 29, 18
var resilience = new AutoPerks.VariablePerk("resilience", 100, true,      [0.01, 1, 0.01], 0.1); // , 1, 1.5, 8, 3.5, 3
var coordinated = new AutoPerks.VariablePerk("coordinated", 150000, true, [36, 75, 75], 0.1); // , 25, 60, 60, 100, 100
...
dumpDropdown.selectedIndex = dumpDropdown.length - 9; // Second to last element is looting_II and -9 is coord (the most expensive one)
