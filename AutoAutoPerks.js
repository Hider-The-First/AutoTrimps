...
var coordinated = new AutoPerks.VariablePerk("coordinated", 150000, true, [(24*(2+Math.pow(game.portal.Coordinated.level,0.1))).toFixed(2), (24*(2+Math.pow(game.portal.Coordinated.level,0.1))).toFixed(2)], 0.1); // , 25, 60, 60, 100, 100
