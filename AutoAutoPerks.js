...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [5+Math.pow(game.portal.Carpentry.level,1.1), 5+Math.pow(game.portal.Carpentry.level,0.55)], 0.05); // , 20, 50, 120, 42, 160
