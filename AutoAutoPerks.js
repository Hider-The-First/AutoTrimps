...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [(5+Math.pow(game.portal.Carpentry.level,0.99)).toFixed(), (5+Math.pow(game.portal.Carpentry.level,0.495)).toFixed()], 0.05); // , 20, 50, 120, 42, 160
...
var motivation = new AutoPerks.VariablePerk("motivation", 2, false,       [(game.portal.Carpentry.level/(6+game.portal.Power.level*0.3)).toFixed(1), (game.portal.Carpentry.level/(6+game.portal.Power.level*0.3)).toFixed(1)], 0.05); // , 1.5, 3, 4, 4, 2.5
