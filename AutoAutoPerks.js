...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [((5+Math.pow(game.portal.Carpentry.level,0.98))*1000).toFixed(), ((5+Math.pow(game.portal.Carpentry.level,0.49))*1000).toFixed()], 0.05); // , 20, 50, 120, 42, 160
var toughness = new AutoPerks.VariablePerk("toughness", 1, false,         [4*1000, 4*1000], 0.05); // , 0.5, 0.75, 4, 1.75, 1.5
var power = new AutoPerks.VariablePerk("power", 1, false,                 [(game.portal.Carpentry.level*1000/(6+game.portal.Power.level*(0.3+game.portal.Power_II.level/25000))).toFixed(), (game.portal.Carpentry.level*1000/(6+game.portal.Power.level*(0.3+game.portal.Power_II.level/25000))).toFixed()], 0.05); // , 1, 1, 4, 5, 5
var motivation = new AutoPerks.VariablePerk("motivation", 2, false,       [(game.portal.Carpentry.level*1000/(6+game.portal.Motivation.level*(0.3+game.portal.Motivation_II.level/25000))).toFixed(), (game.portal.Carpentry.level*1000/(6+game.portal.Motivation.level*(0.3+game.portal.Motivation_II.level/25000))).toFixed()], 0.05); // , 1.5, 3, 4, 4, 2.5
...
var overkill = new AutoPerks.VariablePerk("overkill", 1000000, true,      [3*1000, 0.5*1000], 0.005, 30); // , 3, 5, 3, 5, 10
//tier2 perks
