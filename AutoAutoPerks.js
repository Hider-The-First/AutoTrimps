...
var looting = new AutoPerks.VariablePerk("looting", 1, false,             [((5+Math.pow(game.portal.Carpentry.level,0.97))).toFixed(0), ((5+Math.pow(game.portal.Carpentry.level,0.485))).toFixed(0)], 0.05); // , 20, 50, 120, 42, 160
...
var pheromones = new AutoPerks.VariablePerk("pheromones", 3, false,       [0.1, 0.1], 0.1); // , 0.5, 0.75, 4, 1.5, 1.5
...
var resilience = new AutoPerks.VariablePerk("resilience", 100, true,      [0.1, 0.1], 0.1); // , 1, 1.5, 8, 3.5, 3
var coordinated = new AutoPerks.VariablePerk("coordinated", 150000, true, [(24*(2+Math.pow(game.portal.Coordinated.level,0.2))).toFixed(0), (24*(2+Math.pow(game.portal.Coordinated.level,0.2))).toFixed(0)], 0.1); // , 25, 60, 60, 100, 100
