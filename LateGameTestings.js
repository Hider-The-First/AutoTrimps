...
function autoMap() {
    ...
    if (game.global.mapsUnlocked) {
        ...
        (game.global.mapBonus < 9 && (game.global.world >= (getPageSetting('VoidMaps') + 20) || (game.global.world >= 265 && game.global.world < getPageSetting('VoidMaps'))|| game.global.world == 200 || game.global.world == 250 || game.global.world == 260 || game.global.world == 270 || game.global.world == 280 || game.global.world == 290 || game.global.world == 300 || game.global.world == 310 || game.global.world == 320 || game.global.world == 330 || game.global.world == 340 || game.global.world == 350)) ||
...
function autoGoldenUpgrades() {
    ...
    // get golden voids based on voidmap,(1(2%)/150, 2(6%)/180, 3(12%)/210 4(20%)/240, 5(30%)/270, 6(41%)/300.
