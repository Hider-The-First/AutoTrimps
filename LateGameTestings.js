...
function autoMap() {
    ...
    if (game.global.mapsUnlocked) {
        ...
        (game.global.mapBonus < 9 && (game.global.world >= (getPageSetting('VoidMaps') + 20) || (game.global.world >= (getPageSetting('VoidMaps')-5) || game.global.world == 200 || game.global.world == 250 || game.global.world == 260 || game.global.world == 270 || game.global.world == 280 || game.global.world == 290 || game.global.world == 300 || game.global.world == 310 || game.global.world == 320 || game.global.world == 330 || game.global.world == 340 || game.global.world == 350)) ||
